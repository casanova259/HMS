...
const ANNOUNCEMENT_TYPES = ['General', 'Urgent', 'Event', 'Maintenance', 'Notice'];
...
export default function Announcements() {
  ...
  const [statusFilter, setStatusFilter] = useState<'Active' | 'Scheduled' | 'Archived' | 'All'>('All');
  ...
  const [formData, setFormData] = useState({
    title: '',
    content: '',
    type: 'General' as 'General' | 'Urgent' | 'Event' | 'Maintenance' | 'Notice',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Create and manage announcements for students</p>
        </div>
        <button
      ...
      <div className="space-y-4">
        {filteredAnnouncements.length > 0 ? (
          filteredAnnouncements.map((announcement) => (
            <div key={announcement.id} className="bg-white rounded-lg p-6 shadow hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge label={announcement.type} color="bg-blue-100 text-blue-800" />
                    <Badge
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="flex items-center">
              ...
              />
              <span className="ml-2 text-sm font-medium text-gray-700">Send to all students</span>
            </label>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Posted {getTimeAgo(selectedAnnouncement.createdAt)}</p>
              </div>
            </div>

            <div className="flex flex-wrap gap-2">
              <Badge label={selectedAnnouncement.type} color="bg-blue-100 text-blue-800" />
              <Badge
            ...
            <div className="pt-4 border-t space-y-2 text-sm text-gray-600">
              <p>
                <span className="font-medium">Posted by:</span> {selectedAnnouncement.postedBy}
              </p>
              <p>
                <span className="font-medium">Views:</span> {selectedAnnouncement.views}
              </p>
              <p>
                <span className="font-medium">Status:</span> {selectedAnnouncement.status}
              </p>
            </div>
